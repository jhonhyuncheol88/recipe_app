...
/// 소스 재료 선택 페이지
class SauceIngredientSelectPage extends StatefulWidget {
  final String sauceId;

  const SauceIngredientSelectPage({
    super.key,
    required this.sauceId,
  });

  @override
  State<SauceIngredientSelectPage> createState() =>
      _SauceIngredientSelectPageState();
}

class _SauceIngredientSelectPageState extends State<SauceIngredientSelectPage> {
  final List<Ingredient> _availableIngredients = [];
  final List<Ingredient> _selectedIngredients = [];
  final Map<String, double> _ingredientAmounts = {};
  final Map<String, String> _ingredientUnitIds = {};
  ...
  Future<void> _completeSelection() async {
    ...
    try {
      final sauceCubit = context.read<SauceCubit>();
      ...
      for (final ingredient in _selectedIngredients) {
        ...
        await sauceCubit.addIngredientToSauce(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppStrings.getAddIngredientToSauce(currentLocale),
                  ...
                  child: filteredIngredients.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (!unitOptions.contains(currentUnitId)) {
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                if (mounted) {
                                  setState(() {
